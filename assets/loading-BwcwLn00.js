import{r as j,j as e}from"./index-B5qqyIUh.js";import{B as o,T as d}from"./Modal-BJkHogad.js";import{G as k}from"./Grid-DEDFNMlA.js";import{g as R,a as S,u as $,c as A,b as M,s as U,m as B,C as x,E as y}from"./TransitionGroupContext-B2FQ4Ct2.js";function E(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function T(t){return parseFloat(t)}function X(t){return R("MuiSkeleton",t)}S("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const F=t=>{const{classes:n,variant:a,animation:r,hasChildren:s,width:l,height:i}=t;return M({root:["root",a,r,s&&"withChildren",s&&!l&&"fitContent",s&&!i&&"heightAuto"]},X,n)},p=y`
  0% {
    opacity: 1;
  }
